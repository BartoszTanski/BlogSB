...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> postNotPoundException(
			PostNotFoundExcepction postNotFoundExcepction, WebRequest webRequest) {
	...
	public ResponseEntity<ErrorMessage> postNotPoundException(
			PostInsertFailedException postInsertFailedException, WebRequest webRequest) {
		
		ErrorMessage message = new ErrorMessage(HttpStatus.BAD_REQUEST,postInsertFailedException.getMessage());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(message);
	}
	@ExceptionHandler(VideoNotFoundException.class)
	public ResponseEntity<ErrorMessage> VideoNotFoundException(
			VideoNotFoundException videoNotFoundException, WebRequest webRequest) {
